...
public class Deposite extends javax.swing.JFrame {
    ...
    public Deposite(String id){
        initComponents();
        this.setBounds(400,200,600,380);
        db=new JDBC();
        id1=id;
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(170, 300, 80, 25);
        ...
        jButton2.setBounds(290, 300, 58, 25);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!s2.equals(pin))
        {
            JOptionPane.showMessageDialog(f, "PIN salah");
        }
        else
        {
            ...
            JOptionPane.showMessageDialog(f, "Saldo Berhasil Ditambah");
            this.dispose();
        }
