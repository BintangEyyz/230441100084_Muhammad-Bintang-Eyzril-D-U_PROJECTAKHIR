...
public class CreateAccount extends javax.swing.JFrame {
    ...
    public CreateAccount() {
        initComponents();
        this.setBounds(400,200,650,380);
        db=new JDBC();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setBounds(20, 170, 30, 20);
        ...
        jRadioButton1.setText("Tabungan");
        ...
        jLabel7.setBounds(20, 250, 50, 20);
        ...
        jLabel8.setBounds(20, 290, 50, 20);

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih Kelamin", "Pria", "Wanita", "Lainnya" }));
        ...
        jLabel9.setText("Negara");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(330, 50, 70, 20);
        ...
        jLabel11.setBounds(330, 130, 50, 20);
        ...
        jButton2.setBounds(360, 310, 58, 25);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jRadioButton1.setActionCommand("Tabungan");
        jRadioButton2.setActionCommand("Giro");
        ...
        {
        JOptionPane.showMessageDialog(f,"Lengkapi form terlebih dahulu");
        }
        else
        {
        ...
        JOptionPane.showMessageDialog(f,"Akun berhasil dibuat");
        try
        {
