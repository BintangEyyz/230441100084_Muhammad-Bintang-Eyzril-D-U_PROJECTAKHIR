...
public class TransactionHistory extends javax.swing.JFrame {
    ...
    public TransactionHistory(String id) {
        ...
        try
        {
          ...
          while(db.rs.next())
          {
              ...
              String send=db.rs.getString("fd_SenderId");
              
              
              String tblData[]={Date,amount,type,send};
    ...
    private void initComponent(){
        ...
        jTable1.setModel(new DefaultTableModel(
            new Object [][] {},
            new String [] {
                "Date", "Amount", "Receiver ID", "Sender ID"
            }
        ));
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tanggal Transaksi", "Jumlah", "Kirim ke", "Pengirim"
            }
        ) {
        ...
        jButton1.setBounds(280, 290, 58, 25);
