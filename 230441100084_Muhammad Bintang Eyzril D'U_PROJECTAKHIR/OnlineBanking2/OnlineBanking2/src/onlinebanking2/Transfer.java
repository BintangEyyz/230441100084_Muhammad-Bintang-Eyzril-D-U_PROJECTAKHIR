...
public class Transfer extends javax.swing.JFrame {
    ...
    public Transfer(String id) {
        initComponents();
        this.setBounds(400,200,514,400);
        db=new JDBC();
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(170, 300, 57, 25);

        jLabel6.setFont(new java.awt.Font("Segoe UI Black", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(204, 204, 255));
        jLabel6.setText("Transfer Uang");
...
if (amount.equals("")) {
    JOptionPane.showMessageDialog(f, "Isi form terlebih dahulu");
} else {
    ...
    if (s14 <= amount11) 
    {
        JOptionPane.showMessageDialog(f, "Saldo tidak mencukupi");
    } else {
